...
const TermsOfService: React.FC = () => {
  return (
    <div style={{ padding: '6rem 5%', color: 'var(--text-main)' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'var(--glass-bg)', padding: '3rem', borderRadius: '2rem', border: '1px solid var(--border-color)', color: 'var(--text-muted)', lineHeight: 1.8 }}>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>1. Acceptance of Terms</h3>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>2. Description of Service</h3>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>3. User Responsibilities</h3>
