...
const PrivacyPolicy: React.FC = () => {
  return (
    <div style={{ background: 'transparent', color: 'var(--text-main)', padding: '6rem 5%' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'var(--glass-bg)', padding: '3rem', borderRadius: '2rem', border: '1px solid var(--border-color)', color: 'var(--text-muted)', lineHeight: 1.8 }}>
          <p>Last updated: May 2026</p>
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>1. Data Collection</h3>
          <p>We collect information you provide directly to us, such as when you create or modify your account, request on-demand services, contact customer support, or otherwise communicate with us.</p>
          
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>2. Use of Information</h3>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>3. Sharing of Information</h3>
