      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'var(--glass-bg)', padding: '3rem', borderRadius: '2rem', border: '1px solid var(--border-color)', color: 'var(--text-muted)', lineHeight: 1.8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <h2 style={{ color: 'var(--text-main)', margin: 0 }}>Fully Protected Transits</h2>
          </div>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>Premium Coverage</h3>
          ...
          <h3 style={{ color: 'var(--text-main)', marginTop: '2rem' }}>Claims Process</h3>
