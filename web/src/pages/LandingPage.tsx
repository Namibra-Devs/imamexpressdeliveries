...
const LandingPage: React.FC = () => {
	...
	const testimonials = [
		...
		{ name: "Brother Sammy", role: "Restaurant Owner", text: "Reliable, secure, and fast. I use them for all our bulk food deliveries during peak hours. Exceptional service." }
	];
