...
const Dashboard: React.FC = () => {
  ...
  const rightContent = (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', padding: '2.5rem', color: '#fff', boxSizing: 'border-box', background: 'radial-gradient(circle at top right, rgba(160, 32, 240, 0.1) 0%, transparent 60%)' }}>
