...
const ActiveRouteMap: React.FC = () => {
  ...
  if (loadError) return <div style={{ color: 'white', padding: '2rem', textAlign: 'center', background: '#16161c', height: '100vh' }}>Error loading maps</div>;
  if (!isLoaded) return <div style={{ color: 'white', padding: '2rem', textAlign: 'center', background: '#16161c', height: '100vh' }}>Loading Map...</div>;
  if (!currentOrder) return null;

  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', background: '#16161c', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        zIndex: 10,
        padding: '1rem',
        background: 'linear-gradient(180deg, rgba(22,22,28,0.9) 0%, rgba(22,22,28,0) 100%)',
        display: 'flex',
        alignItems: 'center',
        gap: '1rem'
      }}>
        ...
        <div style={{ flex: 1 }}>
          <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#fff' }}>Active Route</h3>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
            ...
            <div style={{ flex: 1, overflow: 'hidden' }}>
              ...
              <p style={{ margin: 0, fontSize: '0.9rem', color: '#fff', fontWeight: 600, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>{currentOrder.dropoffLocation}</p>
            </div>
          </div>
        </div>
